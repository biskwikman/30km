...
begin
	...
	for (i, (ver, ax_loc)) in enumerate(zip(["C5", "C6", "C6.1"], [f_map[1,1], f_map[1,2], f_map[2,1]]))
...
manifest_format = "2.0"
project_hash = "9f689fcdda80a47d578046f49a38df00aca7b0ae"
...
git-tree-sha1 = "adb054b2b041d6a57d19c6ce65b9be1b653c9fed"
